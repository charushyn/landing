...
export default function Footer(){
    return(
        <footer class='mobile-s:flex mobile-s:flex-col bg-black text-white py-4 items-center mobile-s:gap-2 mobile-m:gap-4 tablet-l:gap-y-6 tablet-l:py-10'>
            <LinkTo href='/confidentialityPolicy' class='flex flex-row mobile-s:gap-2 cursor-pointer'>
            ...
            <LinkTo href={'/returnPolicy'} class=' underline tablet-m:text-4xl desktop:text-xl cursor-pointer'>Повернення та обмін</LinkTo>
